...
- (void)playVideo
{
    ...
    */
    NSURL *url = [NSURL URLWithString:@"http://content.viki.com/test_ios/ios_240.m3u8"];//test from 
    ...
    [self.videoPlayerViewController playVideoWithTitle:@"JSBC" URL:url videoID:nil shareURL:nil isStreaming:NO playInFullScreen:YES];
}
